    ...
    <main style={{minHeight:'100vh',background:C.fondo,color:C.tinta,fontFamily:'system-ui,sans-serif'}}>
      ...
      <section style={{padding:'16px 22px'}}>
        <div style={{display:'flex',gap:10,alignItems:'center',marginBottom:12,flexWrap:'wrap'}}>
          ...
          <span style={{color:C.gris,fontSize:11.5}}>Lee UTF-8 y ANSI/Excel. Detecta tab, ; o ,. Puedes re-subir las veces que quieras: actualiza por código.</span>
        </div>
