...
export default function Tecnico(){
  ...
  const [cupon,setCupon]=useState(''); const [manual,setManual]=useState(false); const [fotoEtiqueta,setFotoEtiqueta]=useState(null); const [cajas,setCajas]=useState(''); const [caja,setCaja]=useState(''); const [scanOn,setScanOn]=useState(false); const [jornada,setJornada]=useState(null);
