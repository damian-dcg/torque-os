export const T = { bg:'#E9ECEF', surface:'#FFFFFF', surface2:'#F1F3F5', border:'#D3DAE1', text:'#16202B', muted:'#4A5866', brand:'#0E8074', ok:'#15803D', warn:'#B45309', danger:'#B91C1C', info:'#1D4ED8', violet:'#6D28D9', teal:'#0F766E', fam:"'Inter','Segoe UI',system-ui,Arial,sans-serif", r:12 };
export const S = {
  main:{minHeight:'100vh',background:T.bg,color:T.text,fontFamily:T.fam},
  wrap:{padding:'20px 18px',maxWidth:1280,margin:'0 auto'},
  card:{background:T.surface,border:'1px solid '+T.border,borderRadius:T.r,padding:16,marginBottom:14,boxShadow:'0 1px 3px rgba(15,23,42,.08)'},
